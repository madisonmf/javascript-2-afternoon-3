...
//1. Two for loops to test to see if the same element exists. 
// 2. Then, splice out the dupes. 
// 3. Return the new array? 
// 4. Invoke the callback with the modified array.

// .sort If i = i - 1, splice i
...
function getUserById (arrayOfObjects, id, callback){
  for (i = 0; i < arrayOfObjects.length; i++){
    if (arrayOfObjects[i].id === id){
      return callback(arrayOfObjects[i])
    };
  }
};
